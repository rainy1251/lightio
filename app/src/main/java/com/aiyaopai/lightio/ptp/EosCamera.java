...
import com.aiyaopai.lightio.ptp.commands.eos.EosEventCheckCommand;
import com.aiyaopai.lightio.ptp.commands.eos.EosGetLiveViewPictureCommand;
import com.aiyaopai.lightio.ptp.commands.eos.EosOpenSessionAction;
import com.aiyaopai.lightio.ptp.commands.eos.EosSetLiveViewAction;
import com.aiyaopai.lightio.ptp.commands.eos.EosSetPropertyCommand;
import com.aiyaopai.lightio.ptp.commands.eos.EosTakePictureCommand;
...
public class EosCamera extends PtpCamera {
    ...
    public void onEventRateCreated(int objectHandle) {
        onEventRateAdded(objectHandle);
    }
